...
class ApplicationClass
{
	...
	float m_fBoxSize;//Size of the Box
	vector3 m_v3BoxCentroid;//Center of the box

	String m_sSelectedObject;//Selected Object

	static const int m_nPads = 2;
	wiimote m_Wiimote[m_nPads]; //For holding the wiimote controller
	matrix4 m_m4ObjectTranslation[m_nPads];//Creeper Model Matrix
	matrix4 m_m4ObjectOrientation[m_nPads];//Creeper Model Matrix
...
public:
	...
	*/
	...
	/*
	UpdateBox
		Calculates the box that sorrounds the objects
	*/
	void UpdateBox(void);
